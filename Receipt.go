...
func main() {
	client := &http.Client{}
	var data = strings.NewReader(`verifyMenu=true&authorizedID=22BDS0188&_csrf=eb1c7f18-f1d7-4401-b3aa-f7944b90e4bc&nocache=@(new Date().getTime())`)
...
func setHeaders(req *http.Request) {
	...
	req.Header.Set("cookie", "JSESSIONID=89A2ACC31AA35AEAF802E75DECC2984D; _ga=GA1.1.1763604292.1699285434; _ga_VY3TWN1FJ7=GS1.1.1702848300.2.0.1702848300.60.0.0; _hp2_id.3863792970=%7B%22userId%22%3A%224954569497889160%22%2C%22pageviewId%22%3A%226755249576479608%22%2C%22sessionId%22%3A%224822149987821438%22%2C%22identity%22%3Anull%2C%22trackerVersion%22%3A%224.0%22%7D; SERVERID=s2")
...
func parseAndPrintTable(body io.Reader) {
	...
	doc.Find("table.table-bordered tbody tr").Each(func(i int, rowSelection *goquery.Selection) {
		...
		row := []string{strconv.Itoa(serialNumber)} // Add serial number to the row
